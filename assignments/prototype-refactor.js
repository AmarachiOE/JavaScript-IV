...
// the PARENT constructor function -- Gameobject
...
// Class for CHILD -- CharacterStats
...
// Humanoid.prototype = Object.create(CharacterStats.prototype); //access all child's (and parent's) methods/prototypes
// Humanoid.prototype.greet = function() {
//   return `${this.name} offers a greeting in ${this.language}.`;
// };

// Class for GRANDCHILD -- Humanoid
